...
export const LP_TOKEN_NAME = 'XPRESS Token';
export const LP_TOKEN_SYMBOL = 'XPRESS';
...
const WETH_ONLY: ChainTokenList = {
  ...
  [ChainId.FILECOIN]: [WETH[ChainId.FILECOIN]],
};
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.FILECOIN]: [...WETH_ONLY[ChainId.FILECOIN]],
};
